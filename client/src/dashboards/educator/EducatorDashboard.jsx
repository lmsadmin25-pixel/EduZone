...
import { FaBookOpen, FaUsers, FaRupeeSign, FaStar, FaClipboardList, FaChartPie } from 'react-icons/fa';
...
const EducatorDashboard = () => {
  ...
  const cards = [
    ...
    { title: 'Revenue Generated', value: `₹${totalRevenue}`, icon: <FaRupeeSign />, color: 'text-accent-600', bg: 'bg-accent-50' },
